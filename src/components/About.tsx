        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-1 gap-12 items-center mb-16">
            <div className="text-center max-w-3xl mx-auto">
              <h3 className="text-2xl font-semibold mb-6 text-purple-600">Professional Journey</h3>
              ...
              <div className="bg-gradient-to-r from-purple-100 to-blue-100 p-6 rounded-lg mb-6 colorful-shadow">
                <h4 className="text-xl font-semibold mb-3 text-purple-700">Beyond Technology</h4>
